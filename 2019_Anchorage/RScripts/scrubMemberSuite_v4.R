...
colnames(talks)[(ncol(talks)-12):ncol(talks)]<-c("Presenting Author Full Name",paste("Author",1:12,"Full Name"))
talks[,(ncol(talks)-12):ncol(talks)]
...
colnames(talks)[(ncol(talks)-12):ncol(talks)]<-c("Presenting Author Short Name",paste("Author",1:12,"Short Name"))
...
rank<-grep("Preference",colnames(talks))
colnames(talks)
